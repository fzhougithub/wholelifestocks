...
if(!$mybb->input['action'])
{
	...
	{
		$lang->new_version_available = $lang->sprintf($lang->new_version_available, "AllStock {$mybb->version}", "<a href=\"http://mybb.com/downloads\" target=\"_blank\">AllStock {$update_check['latest_version']}</a>");
