...
/**
 * The deal with this file is that it handles all of the XML HTTP Requests for AllStock.
 *
 * It contains a stripped down version of the AllStock core which does not load things
