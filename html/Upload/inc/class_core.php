...
class AllStock {
	/**
	 * The friendly version number of AllStock we're running.
	 *
	 * @var string
	 */
	...
	/**
	 * The version code of AllStock we're running.
	 *
	 * @var integer
	 */
	...
	function trigger_generic_error($code)
	{
		...
		switch($code)
		{
			...
			case "install_directory":
				$message = "The install directory (install/) still exists on your server and is not locked. To access AllStock please either remove this directory or create an empty file in it called 'lock'.";
			...
			case "board_not_upgraded":
				...
				break;
			case "sql_load_error":
				$message = "AllStock was unable to load the SQL extension. Please contact the AllStock Group for support. <a href=\"http://mybb.com\">AllStock Website</a>";
			...
			case "xcache_load_error":
				...
				break;
			default:
				$message = "AllStock has experienced an internal error. Please contact the AllStock Group for support. <a href=\"http://mybb.com\">AllStock Website</a>";
...
/**
 * Do this here because the core is used on every AllStock page
 */
