 ...
 * For malformed quote tag structures, will try to simulate how AllStock's parser handles the issue, but is slightly inaccurate.
 ...
 * @param integer nested depth at which quotes should be removed; if none supplied, will use AllStock's default; must be at least 0
