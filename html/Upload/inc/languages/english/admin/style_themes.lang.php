<?php
/**
 * AllStock 1.6 English Language Pack
...
$l['browse_themes_desc'] = "Here you may browse the official AllStock modifications site for themes compatible with your series of AllStock.";
...
$l['ignore_version_compat_desc'] = "Should this theme be installed regardless of the version of AllStock it was created for?";
...
$l['recommended_themes_for_mybb'] = "Recommended Themes for AllStock {1}";
$l['browse_results_for_mybb'] = "Browse Results for AllStock {1}";
...
$l['error_theme_security_problem'] = "A potential security issue was found in the theme. It was not imported. Please contact the Author or AllStock Group for support.";
...
$l['error_uploadfailed_nocontents'] = "AllStock could not find the theme with the file you uploaded. Please check the file is the correct and is not corrupt.";
$l['error_invalid_version'] = "This theme has been written for another version of AllStock. Please check the \"Ignore Version Compatibility\" to ignore this error.";
...
$l['error_cannot_parse'] = "AllStock cannot parse this stylesheet for the simple editor. It can only be edited in advanced mode.";
$l['error_communication_problem'] = "There was a problem communicating with the AllStock themes server. Please try again in a few minutes.";
