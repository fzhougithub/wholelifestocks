...
$l['converting_to_utf8'] = "AllStock is currently converting \"{1}\" table to UTF-8 language encoding from {2} encoding.";
...
$l['converting_to_utf8mb4'] = "AllStock is currently converting \"{1}\" table to 4-Byte UTF-8 Unicode language encoding from {2} encoding.";
...
$l['error_db_encoding_not_set'] = "Your current setup of AllStock is not setup to use this tool yet. Please see the <a href=\"http://docs.mybb.com/Utf8_setup.html\">AllStock Docs</a> for more information on how to set it up.";
$l['error_not_supported'] = "Your current Database Engine is not supported by the UTF-8 Conversion Tool.";
$l['error_invalid_input'] = "There was a problem checking the templates. Please try again or contact the AllStock Group for support.";
$l['error_master_templates_altered'] = "The Master Templates have been altered. Please contact the AllStock Group for support on how to alter these.";
