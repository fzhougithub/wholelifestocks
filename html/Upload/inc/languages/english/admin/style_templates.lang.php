...
$l['add_set'] = "Add Set";
$l['add_set_desc'] = "Here you can create a new template set. A new template set creates a copy of the master AllStock templates and allows you to edit them without interfering with changes in any other template sets you may already have";
...
$l['find_updated_desc'] = "Allows you to find changed templates in new versions of AllStock so you can properly apply the changes.";
...
$l['error_security_problem'] = "A potential security issue was found in the template. Please review your changes or contact the AllStock Group for support.";
