...
function upgrade12_dbchanges()
{
	...
	else
	{
		...
		echo "<p>AllStock 1.4 represents a huge leap forward for the AllStock project.</p><p>Due to this, lots of information in the database needs to be converted to a new format.</p>";
	}

	echo "<p>AllStock is now currently converting a section of data to the new format, this may take a while.</p>";
 ...
 *
 * Please see the AllStock Docs for advanced
 ...
 *  of the most commonly accessed data in AllStock.
...
/**
 * Database Encoding
 *  If you wish to set an encoding for AllStock uncomment
 ...
 *  The AllStock task system can automatically prune
 *  various log files created by AllStock.
...
function upgrade12_redothemes()
{
	...
	// Define our default stylesheets - AllStock 1.4 contains additional stylesheets that our converted themes will also need
