...
/*
 * AllStock Admin CP Page Generation Class
 */
class DefaultPage
{
	...
	function output_header($title="")
	{
		...
		echo "	<meta name=\"author\" content=\"AllStock Group\" />\n";
		echo "	<meta name=\"copyright\" content=\"Copyright ".COPY_YEAR." AllStock.\" />\n";
...
//]]>
	...
	function output_footer($quit=true)
	{
		...
		echo "	<br style=\"clear: both;\" />";
		echo "	</div>\n";
		echo "<div id=\"footer\"><p class=\"generation\">".$lang->sprintf($lang->generated_in, $totaltime, $querycount, $memory_usage)."</p><p class=\"powered\">Powered By AllStock. &copy; ".COPY_YEAR." AllStock. All Rights Reserved.</p></div>\n";
		if($mybb->debug_mode)
		{
			echo $db->explain;
		}
...
<meta name="author" content="AllStock Group" />
<meta name="copyright" content="Copyright {$copy_year} AllStock Group." />
