...
if($mybb->input['action'] == "do_check_templates" && $mybb->request_method == "post")
{
	...
	$templatesets = array(
		-2 => array(
			"title" => "AllStock Master Templates"
		)
	);
...
if(!$mybb->input['action'])
{
	...
	if($errors)
	{
		$page->output_error("<p><em>{$errors} {$lang->error_chmod}</span></strong> {$lang->chmod_info} <a href=\"http://docs.mybb.com/HowTo_Chmod.html\" target=\"_blank\">AllStock Docs</a>.</em></p>");
	}
	else
	{
