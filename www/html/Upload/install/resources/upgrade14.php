...
function upgrade14_dbchanges2()
{
	...
	$db->update_query("helpdocs", array('document' => $db->escape_string("AllStock makes use of cookies to store your login information if you are registered, and your last visit if you are not.
