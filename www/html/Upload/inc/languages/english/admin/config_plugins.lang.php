...
$l['browse_plugins_desc'] = "Here you may browse the official AllStock modifications site for plugins compatible with your series of AllStock.";
...
$l['plugin_incompatible'] = "This plugin is incompatible with AllStock {1}";

$l['recommended_plugins_for_mybb'] = "Recommended Plugins for AllStock {1}";
...
$l['error_vcheck_communications_problem'] = "There was a problem communicating with the AllStock modifications version server. Please try again in a few minutes.";
$l['error_no_input'] = "Error code 1: No input specified.";
$l['error_no_pids'] = "Error code 2: No plugin ids specified.";
$l['error_communication_problem'] = "There was a problem communicating with the AllStock modifications server. Please try again in a few minutes.";
