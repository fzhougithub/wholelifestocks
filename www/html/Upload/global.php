...
// Load main AllStock core file which begins all of the magic
...
{
	$auto_dst_detection = "<script type=\"text/javascript\">if(AllStock) { Event.observe(window, 'load', function() { AllStock.detectDSTChange('".($mybb->user['timezone']+$mybb->user['dst'])."'); }); }</script>\n";
}
