...
function getcharts1(){
	title="get_history_scan"
	src="http://107.170.209.150/cgi-bin/history_scan.cgi" 
	echo "<iframe src=$src width=1350 height=300 name=\"bbb\"></iframe>" >> $target
}

function getcharts2(){
echo "<iframe src=http://107.170.209.150/cgi-bin/getall.cgi?ticker=VVUS width=1350 height=450 name=\"aaa\"></iframe>" >> $target
echo "</body></html>" >> $output
}

dir=/var/www/cgi-bin
file=get_history_scan.html
