...
echo "<h1>Our List</h1>" >> $target
echo "<a href=http://107.170.209.150/cgi-bin/refresh_fz.cgi>Refresh</a>>" >> $target
...
echo "<br><a href=http://107.170.209.150/cgi-bin/refresh_fz.cgi>Refresh</a>>" >> $target
